(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["spotifyApp"] = factory();
	else
		root["spotifyApp"] = factory();
...
var TOKEN_API = 'BQACLk8Gp6fjZUJxmMI5i1i-kqltRDxE-07i28DqDJa51qRwgpkxRHdPC8N2JTYgVySs-IiI_jWYrh4vYNcAnF3SPWZSt-UGdScaLTHSGHfH83mPrajO-QJ6zC1QYpEvSKIQr-4BBmZhumk';
...
var getAlbum = exports.getAlbum = function getAlbum(id) {
  return fetch(_config.API_URL + '/albums/' + id).then(_utils2.default);
};

var getAlbums = exports.getAlbums = function getAlbums(ids) {
  return fetch(_config.API_URL + '/albums?ids=' + ids).then(_utils2.default);
};

var getAlbumTracks = exports.getAlbumTracks = function getAlbumTracks(id) {
  return fetch(_config.API_URL + '/albums/' + id + '/tracks').then(_utils2.default);
};

/***/ })
/******/ ]);
});
//# sourceMappingURL=spotify-app.umd.js.map